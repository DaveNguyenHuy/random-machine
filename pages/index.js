  ...
  return (
    <div className="main">
      <div className="container">
        ...
        <h1 style={{color: 'yellow'}}>QUAY SỐ TRÚNG THƯỞNG</h1>
        ...
        <div className="form">
          <label>
            <span>Min:</span>
            <input disabled={loading} value={min} onChange={e => setMin(e.target.value)} min="0" id="min" name="min" type="number" />
          </label>
          <label>
            <span>Max:</span>
            <input disabled={loading} value={max} onChange={e => setMax(e.target.value)} id="max" name="max" type="number" />
          </label>
          <div className="btns">
            <button disabled={!currentList.length || playing} onClick={handleStart} id="start">Start</button>
